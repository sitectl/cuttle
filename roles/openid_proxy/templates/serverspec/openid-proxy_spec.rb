...
{% if openid_proxy.apache.ssl.enabled %}
describe file('/etc/ssl/private/{{ openid_proxy.apache.ssl.name }}.key') do
...
describe file('/etc/ssl/certs/{{ openid_proxy.apache.ssl.name }}.crt') do
