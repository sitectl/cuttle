...
STORAGE_DIR = '{{ graphite.path.data }}'
...
WHISPER_DIR = '{{ graphite.path.data }}/whisper'
RRD_DIR = '{{ graphite.path.data }}/rrd'
#DATA_DIRS = [WHISPER_DIR, RRD_DIR] # Default: set from the above variables
LOG_DIR = '/var/log/graphite/webapp'
INDEX_FILE = '{{ graphite.path.data }}/index'  # Search index file
...
#
DATABASES = {
{% if graphite.mysql.enabled -%}
  'default': {
    'NAME': '{{ graphite.mysql.database }}',
    'ENGINE': 'django.db.backends.mysql',
    'USER': '{{ graphite.mysql.username }}',
...
{%- else -%}
  'default': {
    'NAME': '{{ graphite.path.data }}/graphite.db',
